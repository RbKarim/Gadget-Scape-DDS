...
VALUES(1,'Saber','Official', 1625193819,0);
...
insert into item values(1,'Apple MacBook Air',50);
insert into item values(2,'Razer Blade 15',100);
insert into item values(3,'Dell Vostro 14',130);
insert into item values(4,'HP Pavilion 15-eh1890AU',45);
insert into item values(5,'Lenovo IdeaPad Slim 5i',60);
		
insert into item values(6,'Western Digital Green 480GB SSD',120);
insert into item values(7,'Kingston NV1 250GB NVMe PCIe SSD',200);
insert into item values(8,'Seagate Barracuda Q1 240GB Internal SSD',35);
insert into item values(9,'TEAM T-FORCE VULCAN Z 256GB SATA SSD',60);
insert into item values(10,'TEAM T-Force M200 500GB Portable SSD',58);
		
insert into item values(11,'AMD Ryzen 3 4100',115);
insert into item values(12,'Intel 13th Gen Core i7 13700 Raptor Lake',75);
insert into item values(13,'Intel 10th Gen Core i3 10100F',68);
insert into item values(14,'AMD RYZEN 5 3500',28);
insert into item values(15,'Intel 10th Gen Core i5-10400F',40);
